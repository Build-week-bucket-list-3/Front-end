    ...
    return(
        <div>
            <form onSubmit={handleSubmit(onSubmit)}>
                ...
                <label>Public
                <input type='radio' name='privacy' id='public' value='public' ref={register({required:true, })}/>
                {errors.privacy && 'Field is Required'}
                </label>
                <label>Private
                <input type='radio' name='privacy' id='private' value='private'ref={register({required:true, })}/>
                {errors.privacy && 'Field is Required'}
                </label>
